...
```{r DataExercise-1a}
high_tem_F <- c(72,63,61,53,53,55,61,61,60,59)
low_tem_F <- c(57,56,41,31,36,33,37,39,40,43)
...
```{r DataExercise-1b}
high_tem_C <- c(22,17,16,11,12,13,16,16,16,15)
low_tem_C <- c(14,13,5,-1,2,1,3,4,4,6)
```

Combine your four vectors into a data frame and add informative column names.

```{r DataExercise-1c}
temp.df <- data.frame(high_tem_F,high_tem_C,low_tem_F,low_tem_C)
