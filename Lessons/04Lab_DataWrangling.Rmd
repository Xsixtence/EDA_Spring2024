...
NTL.phys.data.TuesdayLake <- filter(NTL.phys.data, lakename == "Tuesday Lake", year4 %in% c(1990:1999))
...
#ex3 <- filter(NTL.phys.data, lakename == "Tuesday Lake", daynum %in% c(183:213), year4 %in% c(1990:1999))
ex3b <- 
  NTL.phys.data %>% 
